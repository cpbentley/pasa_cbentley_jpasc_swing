 ...
 *
 */
public class PublicKeyJavaComboBox extends JComboBox<String> implements IStringable {
   ...
   private ComboBoxModelSortedHashMapPublicKeyJava comboModel;

   private boolean                                 isFireEvents     = true;

   private PascalSwingCtx                          psc;

   public PublicKeyJavaComboBox(PascalSwingCtx psc, ActionListener al, ComboBoxModelSortedHashMapPublicKeyJava model) {
      this.psc = psc;
   ...
   public ComboBoxModelSortedHashMapPublicKeyJava getModelKey() {
      return comboModel;
   }

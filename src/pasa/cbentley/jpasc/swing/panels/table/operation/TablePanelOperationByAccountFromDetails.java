...
/**
 * List all the operations for the details
 * @author Charles Bentley
 *
 */
public class TablePanelOperationByAccountFromDetails extends TablePanelOperationAbstract implements IMyTab, IWorkerPanel, ActionListener {
   /**
    * 
    */
   ...
   public TablePanelOperationByAccountFromDetails(PascalSwingCtx psc, IRootTabPane root, boolean embedded) {

 ...
 *
 */
public class TablePanelPublicKeyJavaChainWalletPrivate extends TablePanelPublicKeyJavaChainAbstract {
   
   
   public static final String KEY                       = "list_wallet_priv_keys";
   ...
   public TablePanelPublicKeyJavaChainWalletPrivate(PascalSwingCtx psc, IRootTabPane root) {
      super(psc, KEY, root);
   }

 ...
 *
 */
public class PanelWhaleWatchPasaAmountSent extends PanelWhaleWatchAbstract implements IMyTab {
   ...
   public PanelWhaleWatchPasaAmountSent(PascalSwingCtx psc, IRootTabPane root) {
    ...
    * @param root
    */
   public PanelWhaleWatchPasaAmountSent(PascalSwingCtx psc, String id, IRootTabPane root) {
      super(psc, id, root);
   }

...
/**
 * Wathc a specific account for operations
 * @author Charles Bentley
 *
 */
public class PanelWhaleWatchKeyAmount extends PanelWhaleWatchAbstract implements IMyTab {
   ...
   public PanelWhaleWatchKeyAmount(PascalSwingCtx psc, IRootTabPane root) {
      super(psc, "whale_price", root);
   }

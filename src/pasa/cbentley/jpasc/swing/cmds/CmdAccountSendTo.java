 ...
 *
 */
public class CmdAccountSendTo extends CmdShowAbstract<ICommandableAccount> {

   protected final String keyBase = "cmd.account.send.to";

   
   public CmdAccountSendTo(PascalCmdManager pcm, int type) {
      super(pcm, type);
   }

 ...
 *
 */
public class CellRendererAccountOpCount extends PascalTableCellRenderer implements TableCellRenderer {

   /**
    * 
    */
   private static final long serialVersionUID = -4734646269068329510L;

   public CellRendererAccountOpCount(PascalSwingCtx psc) {
      super(psc);
   }

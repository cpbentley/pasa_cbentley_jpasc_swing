 ...
 * <br>
 * @see CellRendererAccount
 * @author Charles Bentley
 *
 */
public class CellRendererOpAccount extends PascalTableCellRenderer implements TableCellRenderer {
   ...
   public CellRendererOpAccount(PascalSwingCtx psc) {
      super(psc);
      dataUpdate();
   }
   ...
   public Component getTableCellRendererComponent(JTable table, Object account, boolean isSelected, boolean hasFocus, int row, int column) {
      ...
      if (account == null) {
         //set color to?
         renderer.setBackground(defBackgroundColor);
         return this;
      }
   ...
   public void dataUpdate() {
      defBackgroundColor = psc.getSwingCtx().getUIData().getCLabelBackground();
   }

   //#mdebug
   public void toString(Dctx dc) {
      dc.root(this, "CellRendererOpAccount");
      super.toString(dc.sup());
   }

   public void toString1Line(Dctx dc) {
      dc.root1Line(this, "CellRendererOpAccount");

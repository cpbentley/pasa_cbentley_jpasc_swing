 ...
 *
 */
public class CellRendererAccountPascal extends PascalTableCellRenderer implements TableCellRenderer {
   ...
   public BGColor getColorBg(int number) {
      ...
      colors.text = istr.getString();
      colors.textToolTip = sb.toString();
      return colors;
   }

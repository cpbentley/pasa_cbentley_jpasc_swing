...
import pasa.cbentley.jpasc.pcore.task.list.dbolet.operation.ListTaskOperationByBlockPredicate;
import pasa.cbentley.jpasc.swing.ctx.PascalSwingCtx;
import pasa.cbentley.jpasc.swing.tablemodels.bentley.ModelTableOperationAbstract;
import pasa.cbentley.swing.threads.IWorkerPanel;

public class WorkerTableOperationByPredicate extends WorkerTableOperationAbstract {


   private BlockPredicate predicate;

   public WorkerTableOperationByPredicate(PascalSwingCtx psc, ModelTableOperationAbstract tableModel, IWorkerPanel wp, BlockPredicate predicate) {

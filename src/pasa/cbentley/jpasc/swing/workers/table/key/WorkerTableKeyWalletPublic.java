...
public class WorkerTableKeyWalletPublic extends WorkerTableKeyAbstract {

   public WorkerTableKeyWalletPublic(PascalSwingCtx psc, IWorkerPanel wp, ModelTablePublicKeyJavaAbstract tableModel) {
      super(psc, wp, tableModel);
   }

   protected ListTaskPage<PublicKeyJava> createTaskPage() {
      //use task of the core framework
      ListTaskPublicKeyJavaWalletCannotUse task = new ListTaskPublicKeyJavaWalletCannotUse(psc.getPCtx(), this);

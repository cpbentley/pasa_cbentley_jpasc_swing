...
public class WorkerTableWhaleWatchPasa extends WorkerTableWhaleWatchAbstract {

   private Double         amount;

   ListTaskBlockAbstract listBlocks;

   public WorkerTableWhaleWatchPasa(PascalSwingCtx psc, IWorkerPanel wp, ModelTableOperationAbstract tableModel, double amount, ListTaskBlockAbstract listBlocks) {

 ...
 *
 */
public class WorkerTableAccountWalletMinMaxBalance extends WorkerTableAccountAbstractMinMaxDouble {

   public WorkerTableAccountWalletMinMaxBalance(PascalSwingCtx psc, IWorkerPanel wp, ModelTableAccountAbstract tableModel) {
   ...
   public void toString(Dctx dc) {
      dc.root(this, "WorkerTableAccountWalletMinMaxBalance");
      toStringPrivate(dc);
   ...
   public void toString1Line(Dctx dc) {
      dc.root1Line(this, "WorkerTableAccountWalletMinMaxBalance");
      toStringPrivate(dc);

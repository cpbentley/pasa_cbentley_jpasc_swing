 ...
 *
 */
public class WorkerComboWalletKeyPublic extends WorkerComboAbstract<ComboBoxModelSortedHashMapPublicKeyJava,PublicKeyJava> {

   public WorkerComboWalletKeyPublic(PascalSwingCtx psc, IWorkerPanel wp, ComboBoxModelSortedHashMapPublicKeyJava comboModel) {
   ...
   public void toString(Dctx dc) {
      dc.root(this, "WorkerComboWalletKeyPublic");
      toStringPrivate(dc);
   ...
   public void toString1Line(Dctx dc) {
      dc.root1Line(this, "WorkerComboWalletKeyPublic");
      toStringPrivate(dc);

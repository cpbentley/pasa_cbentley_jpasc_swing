 ...
 * JOrbis.
 * <br>
 * From http://www.cokeandcode.com/main/code/
 * 
 * @author kevin
 */
public class OggClipPascal implements AutoCloseable {
    ...
    */
   public OggClipPascal(String ref) throws IOException {
      try {
    ...
    */
   public OggClipPascal(InputStream in) throws IOException {
      init(in);
   }
      ...
      try {
         ...
         try {
            ...
            if (lineListener != null) {
               outputLine.addLineListener(lineListener);
            }
   ...
   public FloatControl getVolumeControl() {
      if (outputLine != null) {
         return (FloatControl) outputLine.getControl(FloatControl.Type.MASTER_GAIN);
      }
      return null;
   }
}
